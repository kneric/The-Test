...
function numberArrayOperation(arr) {
  ...
  var totalGanjil = 0
  for (var k = 0; k < ganjil.length; k++) {
    totalGanjil += ganjil[k]
  }
  var totalKelipatan4 = 0
  for (var l = 0; l < kelipatan4.length; l++) {
    totalKelipatan4 += kelipatan4[l]
  }
  result = [totalGenap + totalGanjil +totalKelipatan4]
  return result;
}
